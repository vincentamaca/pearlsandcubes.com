		...
		<div class="card-body">
			<form action="" id="manage-settings">
				<div class="form-group">
					<label for="name" class="control-label">Name your Business</label>
					<input type="text" class="form-control" id="name" name="name" value="Pearls&Cubes" required>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="about" class="control-label">Write About Business</label>
					<textarea name="about" class="text-jqte"><?php echo isset($meta['about_content']) ? $meta['about_content'] : '' ?></textarea>

				</div>
				<div class="form-group">
					<label for="" class="control-label">Choose your Background</label>
