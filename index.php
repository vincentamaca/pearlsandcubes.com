...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <img class="logo" href="index.php" src="logo.png" alt="">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="account.php">Account</a></li>
  ...
  <div class="modal fade" id="uni_modal_right" role='dialog'>
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg py-4">
            <div class="container">
              <div class="small"> Pearls &amp; Cubes <a href="https://www.facebook.com/PearlsandCubes" target="_blank" class="pc">PEARLS&amp;CUBES</a></div>
            </div>
        </footer>
